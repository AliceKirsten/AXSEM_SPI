...
#define NBFI_UL_FREQ_BASE       868800000 + 20000
#define NBFI_DL_FREQ_BASE       433000000

#define RF_POWER 0
#define RF_MAX_POWER 26
...
//void            NBFi_RX_DL_EndHandler(struct wtimer_desc  *desc);
//void            NBFi_Receive_Timeout_cb(struct wtimer_desc  *desc);
//void            NBFi_Wait_Extra_Handler(struct wtimer_desc  *desc);
//void            NBFi_SendHeartBeats(struct wtimer_desc  *desc);
...
///* Phy */
//bool            NBFi_Match_ID(uint8_t  * addr);
...
//bool                                NBFi_Check_RX_Packet_Duplicate(nbfi_pfy_packet_t  * pkt, uint8_t len);
